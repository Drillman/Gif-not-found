...
require(plugin_dir_path(__FILE__).'widget_gif_not_found.php');

// declare functions to load required files
...
{
    wp_enqueue_style('gif_not_found_stylesheet', plugin_dir_url(__FILE__) . 'index.css', [], null);
}
